...
export const DATA_VIEWER_TABLES = [
  ...
  { value: 'shopify_price_rules', label: 'Shopify Price Rules' },
  { value: 'shopify_discount_codes', label: 'Shopify Discount Codes' },
  { value: 'shopify_marketing_events', label: 'Shopify Marketing Events' },
  { value: 'shopify_abandoned_checkouts_history', label: 'Shopify Abandoned Checkouts' },
